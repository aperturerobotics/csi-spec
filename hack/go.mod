...
replace github.com/aperturerobotics/csi-spec => ../
...
require (
	github.com/aperturerobotics/csi-spec v0.0.0-00010101000000-000000000000
	github.com/aperturerobotics/goprotowrap v0.4.1
