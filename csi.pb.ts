...
import {
  BoolValue,
  Int64Value,
} from '@aperturerobotics/ts-proto-common-types/google/protobuf/wrappers.pb.js'
...
export interface PluginCapability {
  type?:
    | { $case: 'service'; service: PluginCapability_Service }
    | {
...
export function pluginCapability_Service_TypeFromJSON(
  object: any
...
export function pluginCapability_Service_TypeToJSON(
  object: PluginCapability_Service_Type
): string {
  switch (object) {
...
export function pluginCapability_VolumeExpansion_TypeFromJSON(
  object: any
...
export function pluginCapability_VolumeExpansion_TypeToJSON(
  object: PluginCapability_VolumeExpansion_Type
): string {
  switch (object) {
...
export interface CreateVolumeRequest {
   ...
   */
  volumeContentSource: VolumeContentSource | undefined
  /**
...
export interface VolumeContentSource {
  type?:
    | { $case: 'snapshot'; snapshot: VolumeContentSource_SnapshotSource }
    | { $case: 'volume'; volume: VolumeContentSource_VolumeSource }
}
...
export function volumeCapability_AccessMode_ModeFromJSON(
  object: any
...
export function volumeCapability_AccessMode_ModeToJSON(
  object: VolumeCapability_AccessMode_Mode
): string {
  switch (object) {
...
export interface Volume {
   ...
   * This field is OPTIONAL.
   */
  contentSource: VolumeContentSource | undefined
  /**
   * Specifies where (regions, zones, racks, etc.) the provisioned
...
export interface ValidateVolumeCapabilitiesResponse {
   ...
   * This field is OPTIONAL.
   */
  confirmed: ValidateVolumeCapabilitiesResponse_Confirmed | undefined
  /**
...
export interface GetCapacityResponse {
   ...
   */
  maximumVolumeSize: Long | undefined
  /**
...
export function controllerServiceCapability_RPC_TypeFromJSON(
  object: any
...
export function controllerServiceCapability_RPC_TypeToJSON(
  object: ControllerServiceCapability_RPC_Type
): string {
  switch (object) {
...
export function nodeServiceCapability_RPC_TypeFromJSON(
  object: any
...
export function nodeServiceCapability_RPC_TypeToJSON(
  object: NodeServiceCapability_RPC_Type
): string {
  switch (object) {
...
export const GetPluginInfoRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetPluginInfoRequest>, I>>(
    _: I
  ): GetPluginInfoRequest {
    const message = createBaseGetPluginInfoRequest()
    return message
...
export const GetPluginInfoResponse = {
  encode(
    ...
    Object.entries(message.manifest).forEach(([key, value]) => {
      GetPluginInfoResponse_ManifestEntry.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          const entry3 = GetPluginInfoResponse_ManifestEntry.decode(
            reader,
            reader.uint32()
          )
  ...
  fromJSON(object: any): GetPluginInfoResponse {
    return {
      ...
      vendorVersion: isSet(object.vendorVersion)
        ? String(object.vendorVersion)
        : '',
      manifest: isObject(object.manifest)
        ? Object.entries(object.manifest).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
  ...
  toJSON(message: GetPluginInfoResponse): unknown {
    ...
    message.vendorVersion !== undefined &&
      (obj.vendorVersion = message.vendorVersion)
    obj.manifest = {}
    if (message.manifest) {
  ...
  fromPartial<I extends Exact<DeepPartial<GetPluginInfoResponse>, I>>(
    object: I
  ): GetPluginInfoResponse {
    const message = createBaseGetPluginInfoResponse()
    message.name = object.name ?? ''
    message.vendorVersion = object.vendorVersion ?? ''
    message.manifest = Object.entries(object.manifest ?? {}).reduce<{
      [key: string]: string
    }>((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = String(value)
...
export const GetPluginInfoResponse_ManifestEntry = {
  encode(
    message: GetPluginInfoResponse_ManifestEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetPluginInfoResponse_ManifestEntry>, I>
  >(object: I): GetPluginInfoResponse_ManifestEntry {
    const message = createBaseGetPluginInfoResponse_ManifestEntry()
...
export const GetPluginCapabilitiesRequest = {
  encode(
    _: GetPluginCapabilitiesRequest,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetPluginCapabilitiesRequest>, I>>(
    _: I
  ): GetPluginCapabilitiesRequest {
    const message = createBaseGetPluginCapabilitiesRequest()
    return message
...
export const GetPluginCapabilitiesResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.capabilities.push(
            PluginCapability.decode(reader, reader.uint32())
          )
          break
        default:
          reader.skipType(tag & 7)
  ...
  toJSON(message: GetPluginCapabilitiesResponse): unknown {
    ...
    if (message.capabilities) {
      obj.capabilities = message.capabilities.map((e) =>
        e ? PluginCapability.toJSON(e) : undefined
      )
    } else {
      obj.capabilities = []
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GetPluginCapabilitiesResponse>, I>>(
    ...
    message.capabilities =
      object.capabilities?.map((e) => PluginCapability.fromPartial(e)) || []
    return message
  },
}
...
export const PluginCapability = {
  encode(
    ...
    if (message.type?.$case === 'service') {
      PluginCapability_Service.encode(
        message.type.service,
        writer.uint32(10).fork()
      ).ldelim()
    }
    if (message.type?.$case === 'volumeExpansion') {
      PluginCapability_VolumeExpansion.encode(
        message.type.volumeExpansion,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.type = {
            $case: 'service',
            service: PluginCapability_Service.decode(reader, reader.uint32()),
          }
          break
        case 2:
          message.type = {
            $case: 'volumeExpansion',
            volumeExpansion: PluginCapability_VolumeExpansion.decode(
              reader,
              reader.uint32()
            ),
          }
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<PluginCapability | PluginCapability[]>
      | Iterable<PluginCapability | PluginCapability[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): PluginCapability {
    return {
      type: isSet(object.service)
        ? {
            $case: 'service',
            service: PluginCapability_Service.fromJSON(object.service),
          }
        : isSet(object.volumeExpansion)
        ? {
            $case: 'volumeExpansion',
            volumeExpansion: PluginCapability_VolumeExpansion.fromJSON(
              object.volumeExpansion
            ),
          }
        : undefined,
    }
  ...
  toJSON(message: PluginCapability): unknown {
    ...
    message.type?.$case === 'service' &&
      (obj.service = message.type?.service
        ? PluginCapability_Service.toJSON(message.type?.service)
        : undefined)
  ...
  fromPartial<I extends Exact<DeepPartial<PluginCapability>, I>>(
    object: I
  ): PluginCapability {
    const message = createBasePluginCapability()
    if (
      object.type?.$case === 'service' &&
      object.type?.service !== undefined &&
      object.type?.service !== null
    ) {
      message.type = {
        $case: 'service',
        service: PluginCapability_Service.fromPartial(object.type.service),
      }
    }
    if (
      ...
      message.type = {
        $case: 'volumeExpansion',
        volumeExpansion: PluginCapability_VolumeExpansion.fromPartial(
          object.type.volumeExpansion
        ),
      }
    }
    return message
...
export const PluginCapability_Service = {
  encode(
    message: PluginCapability_Service,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.type !== 0) {
  ...
  fromJSON(object: any): PluginCapability_Service {
    return {
      type: isSet(object.type)
        ? pluginCapability_Service_TypeFromJSON(object.type)
        : 0,
    }
  },
  ...
  toJSON(message: PluginCapability_Service): unknown {
    ...
    message.type !== undefined &&
      (obj.type = pluginCapability_Service_TypeToJSON(message.type))
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<PluginCapability_Service>, I>>(
    object: I
  ): PluginCapability_Service {
    const message = createBasePluginCapability_Service()
...
export const PluginCapability_VolumeExpansion = {
  encode(
    message: PluginCapability_VolumeExpansion,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type)
  ...
  fromJSON(object: any): PluginCapability_VolumeExpansion {
    return {
      type: isSet(object.type)
        ? pluginCapability_VolumeExpansion_TypeFromJSON(object.type)
        : 0,
    }
  },
  ...
  toJSON(message: PluginCapability_VolumeExpansion): unknown {
    const obj: any = {}
    message.type !== undefined &&
      (obj.type = pluginCapability_VolumeExpansion_TypeToJSON(message.type))
    return obj
  },

  fromPartial<
    I extends Exact<DeepPartial<PluginCapability_VolumeExpansion>, I>
  >(object: I): PluginCapability_VolumeExpansion {
    const message = createBasePluginCapability_VolumeExpansion()
    message.type = object.type ?? 0
    return message
  },
...
export const ProbeRequest = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<ProbeRequest | ProbeRequest[]>
      | Iterable<ProbeRequest | ProbeRequest[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<ProbeRequest>, I>>(
    _: I
  ): ProbeRequest {
    const message = createBaseProbeRequest()
    return message
...
export const ProbeResponse = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<ProbeResponse | ProbeResponse[]>
      | Iterable<ProbeResponse | ProbeResponse[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): ProbeResponse {
    return {
      ready: isSet(object.ready) ? Boolean(object.ready) : undefined,
    }
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ProbeResponse>, I>>(
    object: I
  ): ProbeResponse {
    const message = createBaseProbeResponse()
...
export const CreateVolumeRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          message.volumeCapabilities.push(
            VolumeCapability.decode(reader, reader.uint32())
          )
          break
        case 4:
          const entry4 = CreateVolumeRequest_ParametersEntry.decode(
            reader,
            reader.uint32()
          )
          ...
          break
        case 5:
          const entry5 = CreateVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          ...
          break
        case 6:
          message.volumeContentSource = VolumeContentSource.decode(
            reader,
            reader.uint32()
          )
          break
        case 7:
          message.accessibilityRequirements = TopologyRequirement.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  fromJSON(object: any): CreateVolumeRequest {
    return {
      name: isSet(object.name) ? String(object.name) : '',
      capacityRange: isSet(object.capacityRange)
        ? CapacityRange.fromJSON(object.capacityRange)
        : undefined,
      volumeCapabilities: Array.isArray(object?.volumeCapabilities)
        ? object.volumeCapabilities.map((e: any) =>
            VolumeCapability.fromJSON(e)
          )
        : [],
      ...
      secrets: isObject(object.secrets)
        ? Object.entries(object.secrets).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
              acc[key] = String(value)
              return acc
            },
  ...
  toJSON(message: CreateVolumeRequest): unknown {
    ...
    message.capacityRange !== undefined &&
      (obj.capacityRange = message.capacityRange
        ? CapacityRange.toJSON(message.capacityRange)
        : undefined)
    if (message.volumeCapabilities) {
      obj.volumeCapabilities = message.volumeCapabilities.map((e) =>
        e ? VolumeCapability.toJSON(e) : undefined
      )
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateVolumeRequest>, I>>(
    object: I
  ): CreateVolumeRequest {
    const message = createBaseCreateVolumeRequest()
    message.name = object.name ?? ''
    message.capacityRange =
      object.capacityRange !== undefined && object.capacityRange !== null
        ? CapacityRange.fromPartial(object.capacityRange)
        : undefined
    message.volumeCapabilities =
      object.volumeCapabilities?.map((e) => VolumeCapability.fromPartial(e)) ||
      []
    ...
    message.volumeContentSource =
      object.volumeContentSource !== undefined &&
      object.volumeContentSource !== null
        ? VolumeContentSource.fromPartial(object.volumeContentSource)
        : undefined
    message.accessibilityRequirements =
      object.accessibilityRequirements !== undefined &&
      object.accessibilityRequirements !== null
...
export const CreateVolumeRequest_ParametersEntry = {
  encode(
    message: CreateVolumeRequest_ParametersEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateVolumeRequest_ParametersEntry>, I>
  >(object: I): CreateVolumeRequest_ParametersEntry {
    const message = createBaseCreateVolumeRequest_ParametersEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const CreateVolumeRequest_SecretsEntry = {
  encode(
    message: CreateVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<
          CreateVolumeRequest_SecretsEntry | CreateVolumeRequest_SecretsEntry[]
        >
      | Iterable<
          CreateVolumeRequest_SecretsEntry | CreateVolumeRequest_SecretsEntry[]
        >
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateVolumeRequest_SecretsEntry>, I>
  >(object: I): CreateVolumeRequest_SecretsEntry {
    const message = createBaseCreateVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const VolumeContentSource = {
  encode(
    ...
    if (message.type?.$case === 'snapshot') {
      VolumeContentSource_SnapshotSource.encode(
        message.type.snapshot,
        writer.uint32(10).fork()
      ).ldelim()
    }
    if (message.type?.$case === 'volume') {
      VolumeContentSource_VolumeSource.encode(
        message.type.volume,
        writer.uint32(18).fork()
      ).ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.type = {
            $case: 'snapshot',
            snapshot: VolumeContentSource_SnapshotSource.decode(
              reader,
              reader.uint32()
            ),
          }
        ...
        case 2:
          message.type = {
            $case: 'volume',
            volume: VolumeContentSource_VolumeSource.decode(
              reader,
              reader.uint32()
            ),
          }
  ...
  fromJSON(object: any): VolumeContentSource {
    return {
      type: isSet(object.snapshot)
        ? {
            $case: 'snapshot',
            snapshot: VolumeContentSource_SnapshotSource.fromJSON(
              object.snapshot
            ),
          }
        : isSet(object.volume)
        ? {
            $case: 'volume',
            volume: VolumeContentSource_VolumeSource.fromJSON(object.volume),
          }
        : undefined,
    }
  },
  ...
  toJSON(message: VolumeContentSource): unknown {
    ...
    message.type?.$case === 'volume' &&
      (obj.volume = message.type?.volume
        ? VolumeContentSource_VolumeSource.toJSON(message.type?.volume)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<VolumeContentSource>, I>>(
    object: I
  ): VolumeContentSource {
    const message = createBaseVolumeContentSource()
    if (
      object.type?.$case === 'snapshot' &&
      object.type?.snapshot !== undefined &&
      object.type?.snapshot !== null
    ) {
      message.type = {
        $case: 'snapshot',
        snapshot: VolumeContentSource_SnapshotSource.fromPartial(
          object.type.snapshot
        ),
      }
    }
    if (
      object.type?.$case === 'volume' &&
      object.type?.volume !== undefined &&
      object.type?.volume !== null
    ) {
      message.type = {
        $case: 'volume',
        volume: VolumeContentSource_VolumeSource.fromPartial(
          object.type.volume
        ),
      }
    }
...
export const VolumeContentSource_SnapshotSource = {
  encode(
    message: VolumeContentSource_SnapshotSource,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  fromPartial<
    I extends Exact<DeepPartial<VolumeContentSource_SnapshotSource>, I>
  >(object: I): VolumeContentSource_SnapshotSource {
    const message = createBaseVolumeContentSource_SnapshotSource()
...
export const VolumeContentSource_VolumeSource = {
  encode(
    message: VolumeContentSource_VolumeSource,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.volumeId !== '') {
  ...
  fromPartial<
    I extends Exact<DeepPartial<VolumeContentSource_VolumeSource>, I>
  >(object: I): VolumeContentSource_VolumeSource {
    const message = createBaseVolumeContentSource_VolumeSource()
...
export const CreateVolumeResponse = {
  ...
  toJSON(message: CreateVolumeResponse): unknown {
    ...
    message.volume !== undefined &&
      (obj.volume = message.volume ? Volume.toJSON(message.volume) : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<CreateVolumeResponse>, I>>(
    object: I
  ): CreateVolumeResponse {
    const message = createBaseCreateVolumeResponse()
    message.volume =
...
export const VolumeCapability = {
  encode(
    ...
    if (message.accessType?.$case === 'block') {
      VolumeCapability_BlockVolume.encode(
        message.accessType.block,
        writer.uint32(10).fork()
      ).ldelim()
    }
    if (message.accessType?.$case === 'mount') {
      VolumeCapability_MountVolume.encode(
        message.accessType.mount,
        writer.uint32(18).fork()
      ).ldelim()
    }
    if (message.accessMode !== undefined) {
      VolumeCapability_AccessMode.encode(
        message.accessMode,
        writer.uint32(26).fork()
      ).ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.accessType = {
            $case: 'block',
            block: VolumeCapability_BlockVolume.decode(reader, reader.uint32()),
          }
          break
        case 2:
          message.accessType = {
            $case: 'mount',
            mount: VolumeCapability_MountVolume.decode(reader, reader.uint32()),
          }
          break
        case 3:
          message.accessMode = VolumeCapability_AccessMode.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<VolumeCapability | VolumeCapability[]>
      | Iterable<VolumeCapability | VolumeCapability[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): VolumeCapability {
    return {
      accessType: isSet(object.block)
        ? {
            $case: 'block',
            block: VolumeCapability_BlockVolume.fromJSON(object.block),
          }
        : isSet(object.mount)
        ? {
            $case: 'mount',
            mount: VolumeCapability_MountVolume.fromJSON(object.mount),
          }
        : undefined,
      accessMode: isSet(object.accessMode)
        ? VolumeCapability_AccessMode.fromJSON(object.accessMode)
        : undefined,
    }
  },
  ...
  toJSON(message: VolumeCapability): unknown {
    ...
    message.accessMode !== undefined &&
      (obj.accessMode = message.accessMode
        ? VolumeCapability_AccessMode.toJSON(message.accessMode)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<VolumeCapability>, I>>(
    object: I
  ): VolumeCapability {
    const message = createBaseVolumeCapability()
    if (
      ...
      message.accessType = {
        $case: 'block',
        block: VolumeCapability_BlockVolume.fromPartial(
          object.accessType.block
        ),
      }
    }
    if (
      ...
      message.accessType = {
        $case: 'mount',
        mount: VolumeCapability_MountVolume.fromPartial(
          object.accessType.mount
        ),
      }
    }
    message.accessMode =
      object.accessMode !== undefined && object.accessMode !== null
...
export const VolumeCapability_BlockVolume = {
  encode(
    _: VolumeCapability_BlockVolume,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer
  },
  ...
  fromPartial<I extends Exact<DeepPartial<VolumeCapability_BlockVolume>, I>>(
    _: I
  ): VolumeCapability_BlockVolume {
    const message = createBaseVolumeCapability_BlockVolume()
    return message
...
export const VolumeCapability_MountVolume = {
  encode(
    message: VolumeCapability_MountVolume,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.fsType !== '') {
  ...
  fromJSON(object: any): VolumeCapability_MountVolume {
    return {
      ...
      mountFlags: Array.isArray(object?.mountFlags)
        ? object.mountFlags.map((e: any) => String(e))
        : [],
      volumeMountGroup: isSet(object.volumeMountGroup)
        ? String(object.volumeMountGroup)
        : '',
    }
  },
  ...
  toJSON(message: VolumeCapability_MountVolume): unknown {
    ...
    message.volumeMountGroup !== undefined &&
      (obj.volumeMountGroup = message.volumeMountGroup)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<VolumeCapability_MountVolume>, I>>(
    object: I
  ): VolumeCapability_MountVolume {
    const message = createBaseVolumeCapability_MountVolume()
...
export const VolumeCapability_AccessMode = {
  encode(
    message: VolumeCapability_AccessMode,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.mode !== 0) {
  ...
  fromJSON(object: any): VolumeCapability_AccessMode {
    return {
      mode: isSet(object.mode)
        ? volumeCapability_AccessMode_ModeFromJSON(object.mode)
        : 0,
    }
  },
  ...
  toJSON(message: VolumeCapability_AccessMode): unknown {
    ...
    message.mode !== undefined &&
      (obj.mode = volumeCapability_AccessMode_ModeToJSON(message.mode))
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<VolumeCapability_AccessMode>, I>>(
    object: I
  ): VolumeCapability_AccessMode {
    const message = createBaseVolumeCapability_AccessMode()
...
export const CapacityRange = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<CapacityRange | CapacityRange[]>
      | Iterable<CapacityRange | CapacityRange[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): CapacityRange {
    return {
      requiredBytes: isSet(object.requiredBytes)
        ...
        : Long.ZERO,
      limitBytes: isSet(object.limitBytes)
  ...
  toJSON(message: CapacityRange): unknown {
    const obj: any = {}
    message.requiredBytes !== undefined &&
      (obj.requiredBytes = (message.requiredBytes || Long.ZERO).toString())
    message.limitBytes !== undefined &&
      (obj.limitBytes = (message.limitBytes || Long.ZERO).toString())
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<CapacityRange>, I>>(
    object: I
  ): CapacityRange {
    const message = createBaseCapacityRange()
    message.requiredBytes =
      object.requiredBytes !== undefined && object.requiredBytes !== null
        ? Long.fromValue(object.requiredBytes)
        : Long.ZERO
    message.limitBytes =
      object.limitBytes !== undefined && object.limitBytes !== null
        ? Long.fromValue(object.limitBytes)
        : Long.ZERO
    return message
  },
...
export const Volume = {
  encode(
    ...
    Object.entries(message.volumeContext).forEach(([key, value]) => {
      Volume_VolumeContextEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          const entry3 = Volume_VolumeContextEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry3.value !== undefined) {
          ...
          break
        case 4:
          message.contentSource = VolumeContentSource.decode(
            reader,
            reader.uint32()
          )
          break
        case 5:
          message.accessibleTopology.push(
            Topology.decode(reader, reader.uint32())
          )
          break
        default:
          reader.skipType(tag & 7)
  ...
  fromJSON(object: any): Volume {
    return {
      capacityBytes: isSet(object.capacityBytes)
        ? Long.fromValue(object.capacityBytes)
        : Long.ZERO,
      volumeId: isSet(object.volumeId) ? String(object.volumeId) : '',
      volumeContext: isObject(object.volumeContext)
        ? Object.entries(object.volumeContext).reduce<{
            [key: string]: string
          }>((acc, [key, value]) => {
            acc[key] = String(value)
            return acc
      ...
      contentSource: isSet(object.contentSource)
        ? VolumeContentSource.fromJSON(object.contentSource)
        : undefined,
  ...
  toJSON(message: Volume): unknown {
    const obj: any = {}
    message.capacityBytes !== undefined &&
    ...
    message.contentSource !== undefined &&
      (obj.contentSource = message.contentSource
        ? VolumeContentSource.toJSON(message.contentSource)
        : undefined)
    if (message.accessibleTopology) {
      obj.accessibleTopology = message.accessibleTopology.map((e) =>
        e ? Topology.toJSON(e) : undefined
      )
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<Volume>, I>>(object: I): Volume {
    ...
    message.capacityBytes =
      object.capacityBytes !== undefined && object.capacityBytes !== null
        ? Long.fromValue(object.capacityBytes)
        : Long.ZERO
    message.volumeId = object.volumeId ?? ''
    message.volumeContext = Object.entries(object.volumeContext ?? {}).reduce<{
      [key: string]: string
    }>((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = String(value)
    ...
    message.contentSource =
      object.contentSource !== undefined && object.contentSource !== null
        ? VolumeContentSource.fromPartial(object.contentSource)
        : undefined
    message.accessibleTopology =
      object.accessibleTopology?.map((e) => Topology.fromPartial(e)) || []
    return message
  },
}
...
export const Volume_VolumeContextEntry = {
  encode(
    message: Volume_VolumeContextEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<I extends Exact<DeepPartial<Volume_VolumeContextEntry>, I>>(
    object: I
  ): Volume_VolumeContextEntry {
    const message = createBaseVolume_VolumeContextEntry()
    message.key = object.key ?? ''
...
export const TopologyRequirement = {
  ...
  fromJSON(object: any): TopologyRequirement {
    return {
      requisite: Array.isArray(object?.requisite)
        ? object.requisite.map((e: any) => Topology.fromJSON(e))
        : [],
      preferred: Array.isArray(object?.preferred)
        ? object.preferred.map((e: any) => Topology.fromJSON(e))
        : [],
    }
  },
  ...
  toJSON(message: TopologyRequirement): unknown {
    ...
    if (message.requisite) {
      obj.requisite = message.requisite.map((e) =>
        e ? Topology.toJSON(e) : undefined
      )
    } else {
      obj.requisite = []
    ...
    if (message.preferred) {
      obj.preferred = message.preferred.map((e) =>
        e ? Topology.toJSON(e) : undefined
      )
    } else {
      obj.preferred = []
  ...
  fromPartial<I extends Exact<DeepPartial<TopologyRequirement>, I>>(
    object: I
  ): TopologyRequirement {
    const message = createBaseTopologyRequirement()
    message.requisite =
      object.requisite?.map((e) => Topology.fromPartial(e)) || []
    message.preferred =
      object.preferred?.map((e) => Topology.fromPartial(e)) || []
    return message
  },
}
...
export const Topology = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<Topology | Topology[]>
      | Iterable<Topology | Topology[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromJSON(object: any): Topology {
    return {
      segments: isObject(object.segments)
        ? Object.entries(object.segments).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
              acc[key] = String(value)
              return acc
            },
...
export const Topology_SegmentsEntry = {
  encode(
    message: Topology_SegmentsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<I extends Exact<DeepPartial<Topology_SegmentsEntry>, I>>(
    object: I
  ): Topology_SegmentsEntry {
    const message = createBaseTopology_SegmentsEntry()
    message.key = object.key ?? ''
...
export const DeleteVolumeRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      DeleteVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = DeleteVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteVolumeRequest>, I>>(
    object: I
  ): DeleteVolumeRequest {
    const message = createBaseDeleteVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const DeleteVolumeRequest_SecretsEntry = {
  encode(
    message: DeleteVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<
          DeleteVolumeRequest_SecretsEntry | DeleteVolumeRequest_SecretsEntry[]
        >
      | Iterable<
          DeleteVolumeRequest_SecretsEntry | DeleteVolumeRequest_SecretsEntry[]
        >
  ...
  fromPartial<
    I extends Exact<DeepPartial<DeleteVolumeRequest_SecretsEntry>, I>
  >(object: I): DeleteVolumeRequest_SecretsEntry {
    const message = createBaseDeleteVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const DeleteVolumeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteVolumeResponse>, I>>(
    _: I
  ): DeleteVolumeResponse {
    const message = createBaseDeleteVolumeResponse()
    return message
...
export const ControllerPublishVolumeRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      ControllerPublishVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(42).fork()
      ).ldelim()
    })
    Object.entries(message.volumeContext).forEach(([key, value]) => {
      ControllerPublishVolumeRequest_VolumeContextEntry.encode(
        { key: key as any, value },
        writer.uint32(50).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          message.volumeCapability = VolumeCapability.decode(
            reader,
            reader.uint32()
          )
          break
        case 4:
          ...
          break
        case 5:
          const entry5 = ControllerPublishVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry5.value !== undefined) {
        ...
        case 6:
          const entry6 =
            ControllerPublishVolumeRequest_VolumeContextEntry.decode(
              reader,
              reader.uint32()
            )
  ...
  fromJSON(object: any): ControllerPublishVolumeRequest {
    return {
      ...
      volumeCapability: isSet(object.volumeCapability)
        ? VolumeCapability.fromJSON(object.volumeCapability)
        : undefined,
  ...
  toJSON(message: ControllerPublishVolumeRequest): unknown {
    ...
    message.volumeCapability !== undefined &&
      (obj.volumeCapability = message.volumeCapability
        ? VolumeCapability.toJSON(message.volumeCapability)
        : undefined)
  ...
  fromPartial<I extends Exact<DeepPartial<ControllerPublishVolumeRequest>, I>>(
    ...
    message.volumeCapability =
      object.volumeCapability !== undefined && object.volumeCapability !== null
...
export const ControllerPublishVolumeRequest_SecretsEntry = {
  encode(
    message: ControllerPublishVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            ControllerPublishVolumeRequest_SecretsEntry.encode(p).finish(),
          ]
        }
      } else {
        yield* [
          ControllerPublishVolumeRequest_SecretsEntry.encode(pkt).finish(),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerPublishVolumeRequest_SecretsEntry>, I>
  >(object: I): ControllerPublishVolumeRequest_SecretsEntry {
    const message = createBaseControllerPublishVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const ControllerPublishVolumeRequest_VolumeContextEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message =
      createBaseControllerPublishVolumeRequest_VolumeContextEntry()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ControllerPublishVolumeRequest_VolumeContextEntry>,
      I
    >
  >(object: I): ControllerPublishVolumeRequest_VolumeContextEntry {
    const message =
      createBaseControllerPublishVolumeRequest_VolumeContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
...
export const ControllerPublishVolumeResponse = {
  encode(
    ...
    Object.entries(message.publishContext).forEach(([key, value]) => {
      ControllerPublishVolumeResponse_PublishContextEntry.encode(
        { key: key as any, value },
        writer.uint32(10).fork()
      ).ldelim()
    })
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 =
            ControllerPublishVolumeResponse_PublishContextEntry.decode(
              reader,
              reader.uint32()
            )
          if (entry1.value !== undefined) {
  ...
  fromJSON(object: any): ControllerPublishVolumeResponse {
    return {
      publishContext: isObject(object.publishContext)
        ? Object.entries(object.publishContext).reduce<{
            [key: string]: string
          }>((acc, [key, value]) => {
            acc[key] = String(value)
            return acc
  ...
  fromPartial<I extends Exact<DeepPartial<ControllerPublishVolumeResponse>, I>>(
    ...
    const message = createBaseControllerPublishVolumeResponse()
    message.publishContext = Object.entries(
...
export const ControllerPublishVolumeResponse_PublishContextEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message =
      createBaseControllerPublishVolumeResponse_PublishContextEntry()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ControllerPublishVolumeResponse_PublishContextEntry>,
      I
    >
  >(object: I): ControllerPublishVolumeResponse_PublishContextEntry {
    const message =
      createBaseControllerPublishVolumeResponse_PublishContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
...
export const ControllerUnpublishVolumeRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      ControllerUnpublishVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          const entry3 = ControllerUnpublishVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry3.value !== undefined) {
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerUnpublishVolumeRequest>, I>
  >(object: I): ControllerUnpublishVolumeRequest {
    const message = createBaseControllerUnpublishVolumeRequest()
    message.volumeId = object.volumeId ?? ''
    message.nodeId = object.nodeId ?? ''
    message.secrets = Object.entries(object.secrets ?? {}).reduce<{
...
export const ControllerUnpublishVolumeRequest_SecretsEntry = {
  encode(
    message: ControllerUnpublishVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            ControllerUnpublishVolumeRequest_SecretsEntry.encode(p).finish(),
          ]
        }
      } else {
        yield* [
          ControllerUnpublishVolumeRequest_SecretsEntry.encode(pkt).finish(),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ControllerUnpublishVolumeRequest_SecretsEntry>,
      I
    >
  >(object: I): ControllerUnpublishVolumeRequest_SecretsEntry {
    const message = createBaseControllerUnpublishVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const ControllerUnpublishVolumeResponse = {
  encode(
    _: ControllerUnpublishVolumeResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerUnpublishVolumeResponse>, I>
  >(_: I): ControllerUnpublishVolumeResponse {
    const message = createBaseControllerUnpublishVolumeResponse()
    return message
  },
}
...
export const ValidateVolumeCapabilitiesRequest = {
  encode(
    ...
    Object.entries(message.volumeContext).forEach(([key, value]) => {
      ValidateVolumeCapabilitiesRequest_VolumeContextEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork()
      ).ldelim()
    })
    ...
    Object.entries(message.parameters).forEach(([key, value]) => {
      ValidateVolumeCapabilitiesRequest_ParametersEntry.encode(
        { key: key as any, value },
        writer.uint32(34).fork()
      ).ldelim()
    })
    Object.entries(message.secrets).forEach(([key, value]) => {
      ValidateVolumeCapabilitiesRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(42).fork()
      ).ldelim()
    })
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          const entry2 =
            ValidateVolumeCapabilitiesRequest_VolumeContextEntry.decode(
              reader,
              reader.uint32()
            )
          if (entry2.value !== undefined) {
        ...
        case 4:
          const entry4 =
            ValidateVolumeCapabilitiesRequest_ParametersEntry.decode(
              reader,
              reader.uint32()
            )
          if (entry4.value !== undefined) {
          ...
          break
        case 5:
          const entry5 = ValidateVolumeCapabilitiesRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry5.value !== undefined) {
  ...
  fromPartial<
    I extends Exact<DeepPartial<ValidateVolumeCapabilitiesRequest>, I>
  >(object: I): ValidateVolumeCapabilitiesRequest {
    const message = createBaseValidateVolumeCapabilitiesRequest()
    message.volumeId = object.volumeId ?? ''
    message.volumeContext = Object.entries(object.volumeContext ?? {}).reduce<{
      [key: string]: string
...
export const ValidateVolumeCapabilitiesRequest_VolumeContextEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message =
      createBaseValidateVolumeCapabilitiesRequest_VolumeContextEntry()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  async *decodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            ValidateVolumeCapabilitiesRequest_VolumeContextEntry.decode(p),
          ]
        }
      } else {
        yield* [
          ValidateVolumeCapabilitiesRequest_VolumeContextEntry.decode(pkt),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ValidateVolumeCapabilitiesRequest_VolumeContextEntry>,
      I
    >
  >(object: I): ValidateVolumeCapabilitiesRequest_VolumeContextEntry {
    const message =
      createBaseValidateVolumeCapabilitiesRequest_VolumeContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
...
export const ValidateVolumeCapabilitiesRequest_ParametersEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message =
      createBaseValidateVolumeCapabilitiesRequest_ParametersEntry()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ValidateVolumeCapabilitiesRequest_ParametersEntry>,
      I
    >
  >(object: I): ValidateVolumeCapabilitiesRequest_ParametersEntry {
    const message =
      createBaseValidateVolumeCapabilitiesRequest_ParametersEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
...
export const ValidateVolumeCapabilitiesRequest_SecretsEntry = {
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            ValidateVolumeCapabilitiesRequest_SecretsEntry.encode(p).finish(),
          ]
        }
      } else {
        yield* [
          ValidateVolumeCapabilitiesRequest_SecretsEntry.encode(pkt).finish(),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ValidateVolumeCapabilitiesRequest_SecretsEntry>,
      I
    >
  >(object: I): ValidateVolumeCapabilitiesRequest_SecretsEntry {
    const message = createBaseValidateVolumeCapabilitiesRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const ValidateVolumeCapabilitiesResponse = {
  encode(
    ...
    if (message.confirmed !== undefined) {
      ValidateVolumeCapabilitiesResponse_Confirmed.encode(
        message.confirmed,
        writer.uint32(10).fork()
      ).ldelim()
    }
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.confirmed =
            ValidateVolumeCapabilitiesResponse_Confirmed.decode(
              reader,
              reader.uint32()
            )
          break
  ...
  fromJSON(object: any): ValidateVolumeCapabilitiesResponse {
    return {
      confirmed: isSet(object.confirmed)
        ? ValidateVolumeCapabilitiesResponse_Confirmed.fromJSON(
            object.confirmed
          )
        : undefined,
  ...
  fromPartial<
    I extends Exact<DeepPartial<ValidateVolumeCapabilitiesResponse>, I>
  >(object: I): ValidateVolumeCapabilitiesResponse {
    const message = createBaseValidateVolumeCapabilitiesResponse()
    message.confirmed =
      object.confirmed !== undefined && object.confirmed !== null
        ? ValidateVolumeCapabilitiesResponse_Confirmed.fromPartial(
            object.confirmed
          )
        : undefined
...
export const ValidateVolumeCapabilitiesResponse_Confirmed = {
  encode(
    message: ValidateVolumeCapabilitiesResponse_Confirmed,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    Object.entries(message.volumeContext).forEach(([key, value]) => {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 =
            ValidateVolumeCapabilitiesResponse_Confirmed_VolumeContextEntry.decode(
              reader,
              reader.uint32()
            )
          if (entry1.value !== undefined) {
        ...
        case 3:
          const entry3 =
            ValidateVolumeCapabilitiesResponse_Confirmed_ParametersEntry.decode(
              reader,
              reader.uint32()
            )
          if (entry3.value !== undefined) {
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            ValidateVolumeCapabilitiesResponse_Confirmed.encode(p).finish(),
          ]
        }
      } else {
        yield* [
          ValidateVolumeCapabilitiesResponse_Confirmed.encode(pkt).finish(),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ValidateVolumeCapabilitiesResponse_Confirmed>,
      I
    >
  >(object: I): ValidateVolumeCapabilitiesResponse_Confirmed {
    const message = createBaseValidateVolumeCapabilitiesResponse_Confirmed()
    message.volumeContext = Object.entries(object.volumeContext ?? {}).reduce<{
      [key: string]: string
    }>((acc, [key, value]) => {
...
export const ValidateVolumeCapabilitiesResponse_Confirmed_VolumeContextEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message =
      createBaseValidateVolumeCapabilitiesResponse_Confirmed_VolumeContextEntry()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ValidateVolumeCapabilitiesResponse_Confirmed_VolumeContextEntry>,
      I
    >
  >(
    object: I
...
export const ValidateVolumeCapabilitiesResponse_Confirmed_ParametersEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length
    const message =
      createBaseValidateVolumeCapabilitiesResponse_Confirmed_ParametersEntry()
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<ValidateVolumeCapabilitiesResponse_Confirmed_ParametersEntry>,
      I
    >
  >(object: I): ValidateVolumeCapabilitiesResponse_Confirmed_ParametersEntry {
    const message =
      createBaseValidateVolumeCapabilitiesResponse_Confirmed_ParametersEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
...
export const ListVolumesRequest = {
  ...
  fromJSON(object: any): ListVolumesRequest {
    return {
      ...
      startingToken: isSet(object.startingToken)
        ? String(object.startingToken)
        : '',
    }
  },
  ...
  toJSON(message: ListVolumesRequest): unknown {
    ...
    message.startingToken !== undefined &&
      (obj.startingToken = message.startingToken)
    return obj
  },
...
export const ListVolumesResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.entries.push(
            ListVolumesResponse_Entry.decode(reader, reader.uint32())
          )
          break
        case 2:
  ...
  toJSON(message: ListVolumesResponse): unknown {
    ...
    if (message.entries) {
      obj.entries = message.entries.map((e) =>
        e ? ListVolumesResponse_Entry.toJSON(e) : undefined
      )
    } else {
      obj.entries = []
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListVolumesResponse>, I>>(
    ...
    const message = createBaseListVolumesResponse()
    message.entries =
      object.entries?.map((e) => ListVolumesResponse_Entry.fromPartial(e)) || []
...
export const ListVolumesResponse_VolumeStatus = {
  encode(
    message: ListVolumesResponse_VolumeStatus,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          message.volumeCondition = VolumeCondition.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  fromJSON(object: any): ListVolumesResponse_VolumeStatus {
    return {
      publishedNodeIds: Array.isArray(object?.publishedNodeIds)
        ...
        : [],
      volumeCondition: isSet(object.volumeCondition)
        ? VolumeCondition.fromJSON(object.volumeCondition)
        : undefined,
    }
  },
  ...
  toJSON(message: ListVolumesResponse_VolumeStatus): unknown {
    ...
    message.volumeCondition !== undefined &&
      (obj.volumeCondition = message.volumeCondition
        ? VolumeCondition.toJSON(message.volumeCondition)
        : undefined)
    return obj
  },

  fromPartial<
    I extends Exact<DeepPartial<ListVolumesResponse_VolumeStatus>, I>
  >(object: I): ListVolumesResponse_VolumeStatus {
    const message = createBaseListVolumesResponse_VolumeStatus()
    message.publishedNodeIds = object.publishedNodeIds?.map((e) => e) || []
    message.volumeCondition =
      object.volumeCondition !== undefined && object.volumeCondition !== null
...
export const ListVolumesResponse_Entry = {
  encode(
    message: ListVolumesResponse_Entry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.volume !== undefined) {
      Volume.encode(message.volume, writer.uint32(10).fork()).ldelim()
    ...
    if (message.status !== undefined) {
      ListVolumesResponse_VolumeStatus.encode(
        message.status,
        writer.uint32(18).fork()
      ).ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          message.status = ListVolumesResponse_VolumeStatus.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  fromJSON(object: any): ListVolumesResponse_Entry {
    return {
      ...
      status: isSet(object.status)
        ? ListVolumesResponse_VolumeStatus.fromJSON(object.status)
        : undefined,
    }
  },
  ...
  toJSON(message: ListVolumesResponse_Entry): unknown {
    ...
    message.status !== undefined &&
      (obj.status = message.status
        ? ListVolumesResponse_VolumeStatus.toJSON(message.status)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<ListVolumesResponse_Entry>, I>>(
    object: I
  ): ListVolumesResponse_Entry {
    const message = createBaseListVolumesResponse_Entry()
    message.volume =
...
export const ControllerGetVolumeRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ControllerGetVolumeRequest>, I>>(
    object: I
  ): ControllerGetVolumeRequest {
    const message = createBaseControllerGetVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const ControllerGetVolumeResponse = {
  encode(
    ...
    if (message.status !== undefined) {
      ControllerGetVolumeResponse_VolumeStatus.encode(
        message.status,
        writer.uint32(18).fork()
      ).ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          message.status = ControllerGetVolumeResponse_VolumeStatus.decode(
            reader,
            reader.uint32()
          )
          break
  ...
  fromJSON(object: any): ControllerGetVolumeResponse {
    return {
      volume: isSet(object.volume) ? Volume.fromJSON(object.volume) : undefined,
      status: isSet(object.status)
        ? ControllerGetVolumeResponse_VolumeStatus.fromJSON(object.status)
        : undefined,
    }
  },
  ...
  toJSON(message: ControllerGetVolumeResponse): unknown {
    ...
    message.status !== undefined &&
      (obj.status = message.status
        ? ControllerGetVolumeResponse_VolumeStatus.toJSON(message.status)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<ControllerGetVolumeResponse>, I>>(
    object: I
  ): ControllerGetVolumeResponse {
    const message = createBaseControllerGetVolumeResponse()
    message.volume =
...
export const ControllerGetVolumeResponse_VolumeStatus = {
  encode(
    message: ControllerGetVolumeResponse_VolumeStatus,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    for (const v of message.publishedNodeIds) {
      writer.uint32(10).string(v!)
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerGetVolumeResponse_VolumeStatus>, I>
  >(object: I): ControllerGetVolumeResponse_VolumeStatus {
    const message = createBaseControllerGetVolumeResponse_VolumeStatus()
    message.publishedNodeIds = object.publishedNodeIds?.map((e) => e) || []
    message.volumeCondition =
      object.volumeCondition !== undefined && object.volumeCondition !== null
...
export const GetCapacityRequest = {
  encode(
    ...
    Object.entries(message.parameters).forEach(([key, value]) => {
      GetCapacityRequest_ParametersEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = GetCapacityRequest_ParametersEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry2.value !== undefined) {
  ...
  fromJSON(object: any): GetCapacityRequest {
    return {
      ...
      parameters: isObject(object.parameters)
        ...
        : {},
      accessibleTopology: isSet(object.accessibleTopology)
        ? Topology.fromJSON(object.accessibleTopology)
        : undefined,
    }
  },
  ...
  toJSON(message: GetCapacityRequest): unknown {
    ...
    message.accessibleTopology !== undefined &&
      (obj.accessibleTopology = message.accessibleTopology
        ? Topology.toJSON(message.accessibleTopology)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<GetCapacityRequest>, I>>(
    object: I
  ): GetCapacityRequest {
    const message = createBaseGetCapacityRequest()
    message.volumeCapabilities =
    ...
    message.accessibleTopology =
      object.accessibleTopology !== undefined &&
      object.accessibleTopology !== null
...
export const GetCapacityRequest_ParametersEntry = {
  encode(
    message: GetCapacityRequest_ParametersEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetCapacityRequest_ParametersEntry>, I>
  >(object: I): GetCapacityRequest_ParametersEntry {
    const message = createBaseGetCapacityRequest_ParametersEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
function createBaseGetCapacityResponse(): GetCapacityResponse {
  return {
    availableCapacity: Long.ZERO,
    maximumVolumeSize: undefined,
    minimumVolumeSize: undefined,
  }
}
...
export const GetCapacityResponse = {
  encode(
    ...
    if (message.maximumVolumeSize !== undefined) {
      Int64Value.encode(
        { value: message.maximumVolumeSize! },
        writer.uint32(18).fork()
      ).ldelim()
    }
    if (message.minimumVolumeSize !== undefined) {
      Int64Value.encode(
        { value: message.minimumVolumeSize! },
        writer.uint32(26).fork()
      ).ldelim()
    }
    return writer
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          message.maximumVolumeSize = Int64Value.decode(
            reader,
            reader.uint32()
          ).value
          break
        case 3:
          message.minimumVolumeSize = Int64Value.decode(
            reader,
            reader.uint32()
          ).value
          break
  ...
  fromJSON(object: any): GetCapacityResponse {
    return {
      availableCapacity: isSet(object.availableCapacity)
      ...
      maximumVolumeSize: isSet(object.maximumVolumeSize)
        ...
        : undefined,
      minimumVolumeSize: isSet(object.minimumVolumeSize)
  ...
  toJSON(message: GetCapacityResponse): unknown {
    ...
    message.availableCapacity !== undefined &&
      (obj.availableCapacity = (
        message.availableCapacity || Long.ZERO
      ).toString())
    message.maximumVolumeSize !== undefined &&
      (obj.maximumVolumeSize = message.maximumVolumeSize)
    message.minimumVolumeSize !== undefined &&
      (obj.minimumVolumeSize = message.minimumVolumeSize)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<GetCapacityResponse>, I>>(
    object: I
  ): GetCapacityResponse {
    const message = createBaseGetCapacityResponse()
    message.availableCapacity =
      object.availableCapacity !== undefined &&
      object.availableCapacity !== null
        ? Long.fromValue(object.availableCapacity)
        : Long.ZERO
    message.maximumVolumeSize =
      object.maximumVolumeSize !== undefined &&
      object.maximumVolumeSize !== null
        ? Long.fromValue(object.maximumVolumeSize)
        : undefined
    message.minimumVolumeSize =
      object.minimumVolumeSize !== undefined &&
      object.minimumVolumeSize !== null
        ? Long.fromValue(object.minimumVolumeSize)
        : undefined
    return message
  },
...
export const ControllerGetCapabilitiesRequest = {
  encode(
    _: ControllerGetCapabilitiesRequest,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerGetCapabilitiesRequest>, I>
  >(_: I): ControllerGetCapabilitiesRequest {
    const message = createBaseControllerGetCapabilitiesRequest()
    return message
  },
}
...
export const ControllerGetCapabilitiesResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.capabilities.push(
            ControllerServiceCapability.decode(reader, reader.uint32())
          )
          break
        default:
          reader.skipType(tag & 7)
    ...
    return {
      capabilities: Array.isArray(object?.capabilities)
        ? object.capabilities.map((e: any) =>
            ControllerServiceCapability.fromJSON(e)
          )
        : [],
    }
  },
  ...
  toJSON(message: ControllerGetCapabilitiesResponse): unknown {
    ...
    if (message.capabilities) {
      obj.capabilities = message.capabilities.map((e) =>
        e ? ControllerServiceCapability.toJSON(e) : undefined
      )
    } else {
      obj.capabilities = []
    }
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerGetCapabilitiesResponse>, I>
  >(object: I): ControllerGetCapabilitiesResponse {
    const message = createBaseControllerGetCapabilitiesResponse()
    message.capabilities =
      object.capabilities?.map((e) =>
        ControllerServiceCapability.fromPartial(e)
      ) || []
    return message
  },
}
...
export const ControllerServiceCapability = {
  encode(
    ...
    if (message.type?.$case === 'rpc') {
      ControllerServiceCapability_RPC.encode(
        message.type.rpc,
        writer.uint32(10).fork()
      ).ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.type = {
            $case: 'rpc',
            rpc: ControllerServiceCapability_RPC.decode(
              reader,
              reader.uint32()
            ),
          }
  ...
  fromJSON(object: any): ControllerServiceCapability {
    return {
      type: isSet(object.rpc)
        ? {
            $case: 'rpc',
            rpc: ControllerServiceCapability_RPC.fromJSON(object.rpc),
          }
        : undefined,
    }
  },
  ...
  toJSON(message: ControllerServiceCapability): unknown {
    ...
    message.type?.$case === 'rpc' &&
      (obj.rpc = message.type?.rpc
        ? ControllerServiceCapability_RPC.toJSON(message.type?.rpc)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<ControllerServiceCapability>, I>>(
    object: I
  ): ControllerServiceCapability {
    const message = createBaseControllerServiceCapability()
    if (
      object.type?.$case === 'rpc' &&
      object.type?.rpc !== undefined &&
      object.type?.rpc !== null
    ) {
      message.type = {
        $case: 'rpc',
        rpc: ControllerServiceCapability_RPC.fromPartial(object.type.rpc),
      }
    }
    return message
  },
...
export const ControllerServiceCapability_RPC = {
  encode(
    message: ControllerServiceCapability_RPC,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type)
  ...
  fromJSON(object: any): ControllerServiceCapability_RPC {
    return {
      type: isSet(object.type)
        ? controllerServiceCapability_RPC_TypeFromJSON(object.type)
        : 0,
    }
  },
  ...
  toJSON(message: ControllerServiceCapability_RPC): unknown {
    const obj: any = {}
    message.type !== undefined &&
      (obj.type = controllerServiceCapability_RPC_TypeToJSON(message.type))
    return obj
  },
...
export const CreateSnapshotRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      CreateSnapshotRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork()
      ).ldelim()
    })
    Object.entries(message.parameters).forEach(([key, value]) => {
      CreateSnapshotRequest_ParametersEntry.encode(
        { key: key as any, value },
        writer.uint32(34).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          const entry3 = CreateSnapshotRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry3.value !== undefined) {
          ...
          break
        case 4:
          const entry4 = CreateSnapshotRequest_ParametersEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry4.value !== undefined) {
  ...
  fromJSON(object: any): CreateSnapshotRequest {
    return {
      sourceVolumeId: isSet(object.sourceVolumeId)
        ? String(object.sourceVolumeId)
        : '',
      name: isSet(object.name) ? String(object.name) : '',
      secrets: isObject(object.secrets)
        ? Object.entries(object.secrets).reduce<{ [key: string]: string }>(
  ...
  toJSON(message: CreateSnapshotRequest): unknown {
    const obj: any = {}
    message.sourceVolumeId !== undefined &&
      (obj.sourceVolumeId = message.sourceVolumeId)
    message.name !== undefined && (obj.name = message.name)
    obj.secrets = {}
    if (message.secrets) {
      Object.entries(message.secrets).forEach(([k, v]) => {
...
export const CreateSnapshotRequest_SecretsEntry = {
  encode(
    message: CreateSnapshotRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateSnapshotRequest_SecretsEntry>, I>
  >(object: I): CreateSnapshotRequest_SecretsEntry {
    const message = createBaseCreateSnapshotRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const CreateSnapshotRequest_ParametersEntry = {
  encode(
    message: CreateSnapshotRequest_ParametersEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateSnapshotRequest_ParametersEntry>, I>
  >(object: I): CreateSnapshotRequest_ParametersEntry {
    const message = createBaseCreateSnapshotRequest_ParametersEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const CreateSnapshotResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateSnapshotResponse>, I>>(
    object: I
  ): CreateSnapshotResponse {
    const message = createBaseCreateSnapshotResponse()
    message.snapshot =
...
export const Snapshot = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<Snapshot | Snapshot[]>
...
export const DeleteSnapshotRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      DeleteSnapshotRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = DeleteSnapshotRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry2.value !== undefined) {
...
export const DeleteSnapshotRequest_SecretsEntry = {
  encode(
    message: DeleteSnapshotRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<DeleteSnapshotRequest_SecretsEntry>, I>
  >(object: I): DeleteSnapshotRequest_SecretsEntry {
    const message = createBaseDeleteSnapshotRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const DeleteSnapshotResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteSnapshotResponse>, I>>(
    _: I
  ): DeleteSnapshotResponse {
    const message = createBaseDeleteSnapshotResponse()
    return message
...
export const ListSnapshotsRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      ListSnapshotsRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(42).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break
        case 5:
          const entry5 = ListSnapshotsRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry5.value !== undefined) {
...
export const ListSnapshotsRequest_SecretsEntry = {
  encode(
    message: ListSnapshotsRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<ListSnapshotsRequest_SecretsEntry>, I>
  >(object: I): ListSnapshotsRequest_SecretsEntry {
    const message = createBaseListSnapshotsRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const ListSnapshotsResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.entries.push(
            ListSnapshotsResponse_Entry.decode(reader, reader.uint32())
          )
          break
        case 2:
          message.nextToken = reader.string()
    ...
    return {
      entries: Array.isArray(object?.entries)
        ? object.entries.map((e: any) =>
            ListSnapshotsResponse_Entry.fromJSON(e)
          )
        : [],
      nextToken: isSet(object.nextToken) ? String(object.nextToken) : '',
    }
  ...
  toJSON(message: ListSnapshotsResponse): unknown {
    ...
    if (message.entries) {
      obj.entries = message.entries.map((e) =>
        e ? ListSnapshotsResponse_Entry.toJSON(e) : undefined
      )
    } else {
      obj.entries = []
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListSnapshotsResponse>, I>>(
    ...
    const message = createBaseListSnapshotsResponse()
    message.entries =
      object.entries?.map((e) => ListSnapshotsResponse_Entry.fromPartial(e)) ||
      []
    message.nextToken = object.nextToken ?? ''
    return message
  },
...
export const ListSnapshotsResponse_Entry = {
  encode(
    message: ListSnapshotsResponse_Entry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.snapshot !== undefined) {
      Snapshot.encode(message.snapshot, writer.uint32(10).fork()).ldelim()
  ...
  fromPartial<I extends Exact<DeepPartial<ListSnapshotsResponse_Entry>, I>>(
    object: I
  ): ListSnapshotsResponse_Entry {
    const message = createBaseListSnapshotsResponse_Entry()
    message.snapshot =
...
export const ControllerExpandVolumeRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      ControllerExpandVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(26).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          const entry3 = ControllerExpandVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry3.value !== undefined) {
...
export const ControllerExpandVolumeRequest_SecretsEntry = {
  encode(
    message: ControllerExpandVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<ControllerExpandVolumeRequest_SecretsEntry>, I>
  >(object: I): ControllerExpandVolumeRequest_SecretsEntry {
    const message = createBaseControllerExpandVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const ControllerExpandVolumeResponse = {
  ...
  fromJSON(object: any): ControllerExpandVolumeResponse {
    return {
      capacityBytes: isSet(object.capacityBytes)
        ? Long.fromValue(object.capacityBytes)
        : Long.ZERO,
      nodeExpansionRequired: isSet(object.nodeExpansionRequired)
        ? Boolean(object.nodeExpansionRequired)
        : false,
    }
  },
  ...
  toJSON(message: ControllerExpandVolumeResponse): unknown {
    ...
    message.capacityBytes !== undefined &&
      (obj.capacityBytes = (message.capacityBytes || Long.ZERO).toString())
    message.nodeExpansionRequired !== undefined &&
      (obj.nodeExpansionRequired = message.nodeExpansionRequired)
    return obj
  },
...
export const NodeStageVolumeRequest = {
  encode(
    ...
    Object.entries(message.publishContext).forEach(([key, value]) => {
      NodeStageVolumeRequest_PublishContextEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork()
      ).ldelim()
    })
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      NodeStageVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(42).fork()
      ).ldelim()
    })
    Object.entries(message.volumeContext).forEach(([key, value]) => {
      NodeStageVolumeRequest_VolumeContextEntry.encode(
        { key: key as any, value },
        writer.uint32(50).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = NodeStageVolumeRequest_PublishContextEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry2.value !== undefined) {
        ...
        case 4:
          ...
          break
        case 5:
          const entry5 = NodeStageVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry5.value !== undefined) {
          ...
          break
        case 6:
          const entry6 = NodeStageVolumeRequest_VolumeContextEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry6.value !== undefined) {
  ...
  fromJSON(object: any): NodeStageVolumeRequest {
    return {
      ...
      publishContext: isObject(object.publishContext)
        ...
        : {},
      stagingTargetPath: isSet(object.stagingTargetPath)
        ? String(object.stagingTargetPath)
        : '',
      volumeCapability: isSet(object.volumeCapability)
        ? VolumeCapability.fromJSON(object.volumeCapability)
        : undefined,
  ...
  toJSON(message: NodeStageVolumeRequest): unknown {
    ...
    message.stagingTargetPath !== undefined &&
      (obj.stagingTargetPath = message.stagingTargetPath)
    message.volumeCapability !== undefined &&
      (obj.volumeCapability = message.volumeCapability
        ? VolumeCapability.toJSON(message.volumeCapability)
        : undefined)
  ...
  fromPartial<I extends Exact<DeepPartial<NodeStageVolumeRequest>, I>>(
    object: I
  ): NodeStageVolumeRequest {
    const message = createBaseNodeStageVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const NodeStageVolumeRequest_PublishContextEntry = {
  encode(
    message: NodeStageVolumeRequest_PublishContextEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<NodeStageVolumeRequest_PublishContextEntry>, I>
  >(object: I): NodeStageVolumeRequest_PublishContextEntry {
    const message = createBaseNodeStageVolumeRequest_PublishContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodeStageVolumeRequest_SecretsEntry = {
  encode(
    message: NodeStageVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<NodeStageVolumeRequest_SecretsEntry>, I>
  >(object: I): NodeStageVolumeRequest_SecretsEntry {
    const message = createBaseNodeStageVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodeStageVolumeRequest_VolumeContextEntry = {
  encode(
    message: NodeStageVolumeRequest_VolumeContextEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<NodeStageVolumeRequest_VolumeContextEntry>, I>
  >(object: I): NodeStageVolumeRequest_VolumeContextEntry {
    const message = createBaseNodeStageVolumeRequest_VolumeContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodeStageVolumeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeStageVolumeResponse>, I>>(
    _: I
  ): NodeStageVolumeResponse {
    const message = createBaseNodeStageVolumeResponse()
    return message
...
export const NodeUnstageVolumeRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeUnstageVolumeRequest>, I>>(
    object: I
  ): NodeUnstageVolumeRequest {
    const message = createBaseNodeUnstageVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const NodeUnstageVolumeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeUnstageVolumeResponse>, I>>(
    _: I
  ): NodeUnstageVolumeResponse {
    const message = createBaseNodeUnstageVolumeResponse()
    return message
...
export const NodePublishVolumeRequest = {
  encode(
    ...
    Object.entries(message.publishContext).forEach(([key, value]) => {
      NodePublishVolumeRequest_PublishContextEntry.encode(
        { key: key as any, value },
        writer.uint32(18).fork()
      ).ldelim()
    })
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      NodePublishVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(58).fork()
      ).ldelim()
    })
    Object.entries(message.volumeContext).forEach(([key, value]) => {
      NodePublishVolumeRequest_VolumeContextEntry.encode(
        { key: key as any, value },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          const entry2 = NodePublishVolumeRequest_PublishContextEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry2.value !== undefined) {
        ...
        case 6:
          ...
          break
        case 7:
          const entry7 = NodePublishVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          ...
          break
        case 8:
          const entry8 = NodePublishVolumeRequest_VolumeContextEntry.decode(
            reader,
            reader.uint32()
          )
  ...
  fromPartial<I extends Exact<DeepPartial<NodePublishVolumeRequest>, I>>(
    object: I
  ): NodePublishVolumeRequest {
    const message = createBaseNodePublishVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const NodePublishVolumeRequest_PublishContextEntry = {
  encode(
    message: NodePublishVolumeRequest_PublishContextEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            NodePublishVolumeRequest_PublishContextEntry.encode(p).finish(),
          ]
        }
      } else {
        yield* [
          NodePublishVolumeRequest_PublishContextEntry.encode(pkt).finish(),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<NodePublishVolumeRequest_PublishContextEntry>,
      I
    >
  >(object: I): NodePublishVolumeRequest_PublishContextEntry {
    const message = createBaseNodePublishVolumeRequest_PublishContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodePublishVolumeRequest_SecretsEntry = {
  encode(
    message: NodePublishVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<NodePublishVolumeRequest_SecretsEntry>, I>
  >(object: I): NodePublishVolumeRequest_SecretsEntry {
    const message = createBaseNodePublishVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodePublishVolumeRequest_VolumeContextEntry = {
  encode(
    message: NodePublishVolumeRequest_VolumeContextEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  async *encodeTransform(
    ...
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
          yield* [
            NodePublishVolumeRequest_VolumeContextEntry.encode(p).finish(),
          ]
        }
      } else {
        yield* [
          NodePublishVolumeRequest_VolumeContextEntry.encode(pkt).finish(),
        ]
      }
    }
  },
  ...
  fromPartial<
    I extends Exact<DeepPartial<NodePublishVolumeRequest_VolumeContextEntry>, I>
  >(object: I): NodePublishVolumeRequest_VolumeContextEntry {
    const message = createBaseNodePublishVolumeRequest_VolumeContextEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodePublishVolumeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodePublishVolumeResponse>, I>>(
    _: I
  ): NodePublishVolumeResponse {
    const message = createBaseNodePublishVolumeResponse()
    return message
...
export const NodeUnpublishVolumeRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeUnpublishVolumeRequest>, I>>(
    object: I
  ): NodeUnpublishVolumeRequest {
    const message = createBaseNodeUnpublishVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const NodeUnpublishVolumeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeUnpublishVolumeResponse>, I>>(
    _: I
  ): NodeUnpublishVolumeResponse {
    const message = createBaseNodeUnpublishVolumeResponse()
    return message
...
export const NodeGetVolumeStatsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeGetVolumeStatsRequest>, I>>(
    object: I
  ): NodeGetVolumeStatsRequest {
    const message = createBaseNodeGetVolumeStatsRequest()
    message.volumeId = object.volumeId ?? ''
...
export const NodeGetVolumeStatsResponse = {
  ...
  fromJSON(object: any): NodeGetVolumeStatsResponse {
    return {
      usage: Array.isArray(object?.usage)
        ? object.usage.map((e: any) => VolumeUsage.fromJSON(e))
        : [],
      volumeCondition: isSet(object.volumeCondition)
        ? VolumeCondition.fromJSON(object.volumeCondition)
        : undefined,
  ...
  toJSON(message: NodeGetVolumeStatsResponse): unknown {
    const obj: any = {}
    if (message.usage) {
      obj.usage = message.usage.map((e) =>
        e ? VolumeUsage.toJSON(e) : undefined
      )
    } else {
      obj.usage = []
    }
  ...
  fromPartial<I extends Exact<DeepPartial<NodeGetVolumeStatsResponse>, I>>(
    object: I
  ): NodeGetVolumeStatsResponse {
    const message = createBaseNodeGetVolumeStatsResponse()
...
export const VolumeUsage = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<VolumeUsage | VolumeUsage[]>
      | Iterable<VolumeUsage | VolumeUsage[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  toJSON(message: VolumeUsage): unknown {
    ...
    message.available !== undefined &&
      (obj.available = (message.available || Long.ZERO).toString())
    message.total !== undefined &&
      (obj.total = (message.total || Long.ZERO).toString())
    message.used !== undefined &&
      (obj.used = (message.used || Long.ZERO).toString())
    message.unit !== undefined &&
      (obj.unit = volumeUsage_UnitToJSON(message.unit))
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<VolumeUsage>, I>>(
    object: I
  ): VolumeUsage {
    const message = createBaseVolumeUsage()
    message.available =
...
export const VolumeCondition = {
  ...
  async *encodeTransform(
    source:
      | AsyncIterable<VolumeCondition | VolumeCondition[]>
      | Iterable<VolumeCondition | VolumeCondition[]>
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<VolumeCondition>, I>>(
    object: I
  ): VolumeCondition {
    const message = createBaseVolumeCondition()
...
export const NodeGetCapabilitiesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeGetCapabilitiesRequest>, I>>(
    _: I
  ): NodeGetCapabilitiesRequest {
    const message = createBaseNodeGetCapabilitiesRequest()
    return message
...
export const NodeGetCapabilitiesResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.capabilities.push(
            NodeServiceCapability.decode(reader, reader.uint32())
          )
          break
        default:
          reader.skipType(tag & 7)
  ...
  toJSON(message: NodeGetCapabilitiesResponse): unknown {
    ...
    if (message.capabilities) {
      obj.capabilities = message.capabilities.map((e) =>
        e ? NodeServiceCapability.toJSON(e) : undefined
      )
    } else {
      obj.capabilities = []
    }
  ...
  fromPartial<I extends Exact<DeepPartial<NodeGetCapabilitiesResponse>, I>>(
    object: I
  ): NodeGetCapabilitiesResponse {
    const message = createBaseNodeGetCapabilitiesResponse()
    message.capabilities =
      object.capabilities?.map((e) => NodeServiceCapability.fromPartial(e)) ||
      []
    return message
  },
}
...
export const NodeServiceCapability = {
  encode(
    ...
    if (message.type?.$case === 'rpc') {
      NodeServiceCapability_RPC.encode(
        message.type.rpc,
        writer.uint32(10).fork()
      ).ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.type = {
            $case: 'rpc',
            rpc: NodeServiceCapability_RPC.decode(reader, reader.uint32()),
          }
          break
        default:
          reader.skipType(tag & 7)
  ...
  fromJSON(object: any): NodeServiceCapability {
    return {
      type: isSet(object.rpc)
        ? { $case: 'rpc', rpc: NodeServiceCapability_RPC.fromJSON(object.rpc) }
        : undefined,
    }
  },
  ...
  toJSON(message: NodeServiceCapability): unknown {
    ...
    message.type?.$case === 'rpc' &&
      (obj.rpc = message.type?.rpc
        ? NodeServiceCapability_RPC.toJSON(message.type?.rpc)
        : undefined)
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<NodeServiceCapability>, I>>(
    object: I
  ): NodeServiceCapability {
    const message = createBaseNodeServiceCapability()
    if (
      ...
      message.type = {
        $case: 'rpc',
        rpc: NodeServiceCapability_RPC.fromPartial(object.type.rpc),
      }
    }
    return message
  },
...
export const NodeServiceCapability_RPC = {
  encode(
    message: NodeServiceCapability_RPC,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type)
  ...
  fromJSON(object: any): NodeServiceCapability_RPC {
    return {
      type: isSet(object.type)
        ? nodeServiceCapability_RPC_TypeFromJSON(object.type)
        : 0,
    }
  },
  ...
  toJSON(message: NodeServiceCapability_RPC): unknown {
    const obj: any = {}
    message.type !== undefined &&
      (obj.type = nodeServiceCapability_RPC_TypeToJSON(message.type))
    return obj
  },

  fromPartial<I extends Exact<DeepPartial<NodeServiceCapability_RPC>, I>>(
    object: I
  ): NodeServiceCapability_RPC {
    const message = createBaseNodeServiceCapability_RPC()
    message.type = object.type ?? 0
...
export const NodeGetInfoRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeGetInfoRequest>, I>>(
    _: I
  ): NodeGetInfoRequest {
    const message = createBaseNodeGetInfoRequest()
    return message
...
export const NodeGetInfoResponse = {
  ...
  fromJSON(object: any): NodeGetInfoResponse {
    return {
      nodeId: isSet(object.nodeId) ? String(object.nodeId) : '',
      maxVolumesPerNode: isSet(object.maxVolumesPerNode)
  ...
  toJSON(message: NodeGetInfoResponse): unknown {
    ...
    message.maxVolumesPerNode !== undefined &&
      (obj.maxVolumesPerNode = (
        message.maxVolumesPerNode || Long.ZERO
      ).toString())
    message.accessibleTopology !== undefined &&
      (obj.accessibleTopology = message.accessibleTopology
        ? Topology.toJSON(message.accessibleTopology)
  ...
  fromPartial<I extends Exact<DeepPartial<NodeGetInfoResponse>, I>>(
    object: I
  ): NodeGetInfoResponse {
    const message = createBaseNodeGetInfoResponse()
    message.nodeId = object.nodeId ?? ''
    message.maxVolumesPerNode =
      object.maxVolumesPerNode !== undefined &&
      object.maxVolumesPerNode !== null
        ? Long.fromValue(object.maxVolumesPerNode)
        : Long.ZERO
    message.accessibleTopology =
      object.accessibleTopology !== undefined &&
...
export const NodeExpandVolumeRequest = {
  encode(
    ...
    Object.entries(message.secrets).forEach(([key, value]) => {
      NodeExpandVolumeRequest_SecretsEntry.encode(
        { key: key as any, value },
        writer.uint32(50).fork()
      ).ldelim()
    })
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break
        case 6:
          const entry6 = NodeExpandVolumeRequest_SecretsEntry.decode(
            reader,
            reader.uint32()
          )
          if (entry6.value !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeExpandVolumeRequest>, I>>(
    object: I
  ): NodeExpandVolumeRequest {
    const message = createBaseNodeExpandVolumeRequest()
    message.volumeId = object.volumeId ?? ''
...
export const NodeExpandVolumeRequest_SecretsEntry = {
  encode(
    message: NodeExpandVolumeRequest_SecretsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== '') {
      writer.uint32(10).string(message.key)
  ...
  fromPartial<
    I extends Exact<DeepPartial<NodeExpandVolumeRequest_SecretsEntry>, I>
  >(object: I): NodeExpandVolumeRequest_SecretsEntry {
    const message = createBaseNodeExpandVolumeRequest_SecretsEntry()
    message.key = object.key ?? ''
    message.value = object.value ?? ''
    return message
...
export const NodeExpandVolumeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<NodeExpandVolumeResponse>, I>>(
    object: I
  ): NodeExpandVolumeResponse {
    const message = createBaseNodeExpandVolumeResponse()
    message.capacityBytes =
...
export class IdentityClientImpl implements Identity {
  ...
  GetPluginInfo(request: GetPluginInfoRequest): Promise<GetPluginInfoResponse> {
    ...
    return promise.then((data) =>
      GetPluginInfoResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  GetPluginCapabilities(
    ...
    return promise.then((data) =>
      GetPluginCapabilitiesResponse.decode(new _m0.Reader(data))
    )
  }
...
export class ControllerClientImpl implements Controller {
  ...
  CreateVolume(request: CreateVolumeRequest): Promise<CreateVolumeResponse> {
    ...
    return promise.then((data) =>
      CreateVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  DeleteVolume(request: DeleteVolumeRequest): Promise<DeleteVolumeResponse> {
    ...
    return promise.then((data) =>
      DeleteVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ControllerPublishVolume(
    ...
    return promise.then((data) =>
      ControllerPublishVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ControllerUnpublishVolume(
    ...
    return promise.then((data) =>
      ControllerUnpublishVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ValidateVolumeCapabilities(
    ...
    return promise.then((data) =>
      ValidateVolumeCapabilitiesResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  GetCapacity(request: GetCapacityRequest): Promise<GetCapacityResponse> {
    ...
    return promise.then((data) =>
      GetCapacityResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ControllerGetCapabilities(
    ...
    return promise.then((data) =>
      ControllerGetCapabilitiesResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  CreateSnapshot(
    ...
    return promise.then((data) =>
      CreateSnapshotResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  DeleteSnapshot(
    ...
    return promise.then((data) =>
      DeleteSnapshotResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ListSnapshots(request: ListSnapshotsRequest): Promise<ListSnapshotsResponse> {
    ...
    return promise.then((data) =>
      ListSnapshotsResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ControllerExpandVolume(
    ...
    return promise.then((data) =>
      ControllerExpandVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  ControllerGetVolume(
    ...
    return promise.then((data) =>
      ControllerGetVolumeResponse.decode(new _m0.Reader(data))
    )
  }
}
...
export interface Node {
  ...
  ): Promise<NodeStageVolumeResponse>
  NodeUnstageVolume(
    request: NodeUnstageVolumeRequest
  ): Promise<NodeUnstageVolumeResponse>
  NodePublishVolume(
    request: NodePublishVolumeRequest
  ): Promise<NodePublishVolumeResponse>
  NodeUnpublishVolume(
  ...
  ): Promise<NodeExpandVolumeResponse>
  NodeGetCapabilities(
...
export class NodeClientImpl implements Node {
  ...
  NodeStageVolume(
    ...
    return promise.then((data) =>
      NodeStageVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodeUnstageVolume(
    ...
    return promise.then((data) =>
      NodeUnstageVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodePublishVolume(
    ...
    return promise.then((data) =>
      NodePublishVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodeUnpublishVolume(
    ...
    return promise.then((data) =>
      NodeUnpublishVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodeGetVolumeStats(
    ...
    return promise.then((data) =>
      NodeGetVolumeStatsResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodeExpandVolume(
    ...
    return promise.then((data) =>
      NodeExpandVolumeResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodeGetCapabilities(
    ...
    return promise.then((data) =>
      NodeGetCapabilitiesResponse.decode(new _m0.Reader(data))
    )
  }
  ...
  NodeGetInfo(request: NodeGetInfoRequest): Promise<NodeGetInfoResponse> {
    ...
    return promise.then((data) =>
      NodeGetInfoResponse.decode(new _m0.Reader(data))
    )
  }
}
